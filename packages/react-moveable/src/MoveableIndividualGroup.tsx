...
class MoveableIndividualGroup extends MoveableManager<GroupableProps & IndividualGroupableProps> {
    ...
    public render() {
        ...
        return (
            <ControlBoxElement cspNonce={cspNonce} ref={ref(this, "controlBox")} className={prefix("control-box")}>
    ...
    public request(ableName: string, param: Record<string, any> = {}, isInstant?: boolean): Requester {
