...
pointer-events: auto;
    ...
    dragControl(moveable: MoveableManagerInterface<OriginDraggableProps & DraggableProps>, e: any) {
        ...
        const result = Draggable.drag(moveable, setCustomDrag(e, moveable.state, dragDelta, !!isPinch, false))!;
    ...
    dragControlEnd(moveable: MoveableManagerInterface<OriginDraggableProps>, e: any) {
        ...
        triggerEvent(moveable, "onDragOriginEnd", fillEndParams<OnDragOriginEnd>(moveable, e, {}));
        return true;
    },
